...
The following complete example demonstrates Bio-DSL's expressiveness for describing a realistic biological system:
...
RUNTIME {
  ...
  monitoring: {
    interval: 10 s,
    metrics: ["flexor.force", "extensor.force", 
              "sensor.reading", "*.viability"],
    alerts: {
      "viability < 80%": "WARNING",
...
\section{Complete Bio-Component Specification Schema}

The full JSON Schema for Bio-Component Spec v0.1:
