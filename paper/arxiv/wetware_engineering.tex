...
\keywords{Software Engineering \and Biological Systems \and Modular Design \and Domain-Specific Language \and Systems Biology}
...
\bibitem{parnas1972} Parnas, D.L. (1972). On the criteria to be used in decomposing systems into modules. \textit{Commun. ACM}, 15(12), 1053-1058.

\bibitem{dijkstra1968} Dijkstra, E.W. (1968). Go to statement considered harmful. \textit{Commun. ACM}, 11(3), 147-148.

\bibitem{gamma1994} Gamma, E., Helm, R., Johnson, R., Vlissides, J. (1994). \textit{Design Patterns}. Addison-Wesley.

\bibitem{fowler2010} Fowler, M. (2010). \textit{Domain-Specific Languages}. Addison-Wesley.

\bibitem{endy2005} Endy, D. (2005). Foundations for engineering biology. \textit{Nature}, 438, 449-453.

\bibitem{galdzicki2014} Galdzicki, M. et al. (2014). The Synthetic Biology Open Language (SBOL). \textit{Nature Biotechnol.}, 32(6), 545-550.

\bibitem{lancaster2014} Lancaster, M.A., Knoblich, J.A. (2014). Organogenesis in a dish. \textit{Science}, 345, 1247125.

\bibitem{bhatia2014} Bhatia, S.N., Ingber, D.E. (2014). Microfluidic organs-on-chips. \textit{Nature Biotechnol.}, 32(8), 760-772.

\bibitem{hucka2003} Hucka, M. et al. (2003). The systems biology markup language (SBML). \textit{Bioinformatics}, 19(4), 524-531.

\bibitem{lloyd2004} Lloyd, C.M., Halstead, M.D., Nielsen, P.F. (2004). CellML: its future, present and past. \textit{Prog. Biophys. Mol. Biol.}, 85, 433-450.

\bibitem{raman2017} Raman, R., Bashir, R. (2017). Biomimicry, biofabrication, and biohybrid systems. \textit{Adv. Healthcare Mater.}, 6(20), 1700496.

\bibitem{ricotti2017} Ricotti, L. et al. (2017). Biohybrid actuators for robotics. \textit{Science Robotics}, 2(12), eaaq0495.

\bibitem{park2016} Park, S.J. et al. (2016). Phototactic guidance of a tissue-engineered soft-robotic ray. \textit{Science}, 353, 158-162.

\bibitem{yuste2017} Yuste, R. et al. (2017). Four ethical priorities for neurotechnologies and AI. \textit{Nature}, 551, 159-163.

\bibitem{hyun2020} Hyun, I., Scharf-Deering, J.C., Lunshof, J.E. (2020). Ethical issues related to brain organoid research. \textit{Brain Res.}, 1732, 146653.
